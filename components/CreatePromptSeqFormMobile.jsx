...
const CreatePromptSeqFormMobile = ({ uniqueTags, type, postState, setPostState, submitting, setOpenedDrawerCreateSeq, handleCreatePromptSequence, handlePromptChange, tagsInputValue, setTagsInputValue }) => {
...
export default CreatePromptSeqFormMobile
